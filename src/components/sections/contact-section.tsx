...
import { fadeInView, motionVariants } from "@/lib/motion";
import { siteConfig } from "@/lib/site";
import { useReducedMotion } from "@/hooks";

export function ContactSection() {
  const reducedMotion = useReducedMotion();
  const variants = motionVariants(reducedMotion);
  const overviewHref = `mailto:${siteConfig.contactEmail}?subject=${encodeURIComponent("Framework Overview Request")}`;
    ...
    >
      ...
      >
        ...
        >
          ...
          <ButtonLink href={overviewHref} variant="secondary">
